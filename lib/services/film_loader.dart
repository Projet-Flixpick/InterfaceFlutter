...
Future<List<Film>> loadFilms() async {
  try {
    ...
    print(
        'Fichier JSON chargé : $jsonString'); // Ajouter un log pour afficher le contenu du fichier JSON
    ...
    print(
        'Erreur lors du chargement des films : $e'); // Affiche l'erreur dans la console
